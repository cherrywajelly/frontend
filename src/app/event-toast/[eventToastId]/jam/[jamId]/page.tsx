...
export default function JamItemPage({ params }: { params: PageParams }) {
  ...
  return (
    <div className="w-full h-lvh">
      ...
      <div className="h-[calc(100vh-144px)] flex flex-col gap-4 bg-gray-05 p-6">
        {/* 선물 토스트 요약 */}
        <div className="py-4 px-5 flex justify-between bg-white border border-gray-10 rounded-[10px]">
          <div className="flex gap-2 items-center">
            <Image
              src={data?.eventToastDataResponse.eventToastIconImageUrl ?? ''}
              alt=""
              width={40}
              height={40}
          ...
          <div className="flex items-center gap-2">
            <Image
              src={data?.eventToastDataResponse.eventToastMemberProfile ?? ''}
              alt=""
              width={24}
              height={24}
